...
called Findza. It has three kinds of listings:
        ...
        messages: [
          {
            role: "system",
            content:
              "You are Northstar AI for Findza, a South African local-services marketplace covering rooms to rent, local businesses, and short one-off piece jobs. Answer normally.",
          },
          {
            role: "user",
            content: message,
